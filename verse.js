...
let VERSES = {
  " soñé": [
   ...
   "soñé que el árbol de la puerta de casa era un limonero",
     "soñé que si cambiaba una letra de mi nombre", 
     "me transformaba en otra persona y vos no me querías",
     ...
     "soñé con Marruecos", 
     "soñé con uno", 
     "soñé que daba clases de cocinar en el aula del colegio con", 
      "una hornalla carcelaria y aceite hirviendo", 
     "soñé que tenía alzheimer", 
     "", 
     "soñé que volaba una sombrilla en la playa y",
      "se me clavaba en el dedo gordo del pie", 
     "soñé que estaba en la orilla y el mar me llevaba", 
     "soñé que me hacía amiga de un cura remisero",
      "me llevaba a bailar a Chocolate",
     "", 
     "soñé que el hoy era un lugar a donde venían a parar",
  ...
  "   soñé": [
     ...
     "soñé con la ciénaga", 
     "", 
     "también soñé que llevaba a mis alumnos a un paseo", 
     "se perdían todos y los tenía que pagar", 
     "soñé que me robaban la médula", 
     "soñé que le preguntaba a mamá de dónde había sacado",
     "cada una de sus plantas", 
     "soñé con el curso de lingüística general", 
     "con lo que dice el curso de lingüística general", 
     "soñé que con María Rosario teníamos que ir a Chapadmalal y",
     "nos tomábamos un colectivo a Polonia", 
     "", 
     "soñé que jugaba al billar", 
     "con bolas que flotaban en el aire a la altura de mis ojos", 
     ...
     "soñé que iba a comprar comida para llevar",
     "a un restaurant bajo el agua", 
  ...
  "    soñé": [
     ...
     "soñé toda una película sobre la 2da guerra mundial. terminaba y",
     "aparecían andrea del boca y segundo cernadas en canal ocho", 
     "soñé que era el fin del mundo, yo tenía una fiesta en NY e iba igual", 
     "soñé que no recordaba la lista de cosas que", 
     "repito siempre antes de salir", 
     ...
     "soñé que no me podía dormir en Australia y", 
     "que caían caballos del cielo", 
     ...
     "soñé que tenía sueño y andaba", 
     "por la vida sin abrir los ojos", 
     "soñé que Austria había cambiado de lugar en el mapa", 
     "soñé un videojuego", 
     "soñé con 500.000 ARA en droga", 
     "soñé con toda la extensión", 
  ...
  "     soñé": [
     ...
     "",
     "soñé que un médico que me gustaba",
     "me invitaba a salir en el consultorio",
     ...
     "soñé que me desaprobaban el final de hispano I porque",
     "iba a rendir con una heladerita de playa",
   ...
   "      soñé": [
      ...
      "soñé que un patinador que siempre veo por la costa era",
      "una criatura no humana que había puesto la municipalidad para vigilar",
      "soñé con florencia y con el abogado",
      "soñé que caminaba de noche por una avenida que",
      "después se hacía ruta",
      "después se hacía puente y",
      "desembocaba en un barco. el barco me llevaba y yo",
      "pensaba 'uh pero si me lleva a otro país no tengo documento'. de repente",
      "aparecía la otra Fernanda Mugica y yo le robaba el documento",
      "soñé que me desvanecía pero en un teatro",
      "soñé que me encontraba a @conmigotampoco comprando en el Aragone",
      "dormí una siesta de cuatro horas y soñé", 
      "que mi madre me contaba había estado presa",
      "soñé que iba al cine, estaba de espaldas a la pantalla, veía al público reírse",
      "cuando miraba la pantalla, veía que lo que se proyectaba", 
      "era el público riéndose y comiendo pochoclo",
      ...
      "soñé que Rocío me decía 'los gatos negros no perdonan'", 
      "y Rocío soñó con un gato negro y ahora me manda foto de un gato negro"
  ...
  "soñé      ": [
    ...
    "alguien lo cambiaba y ponía una canción triste de calamaro", 
     "y se reía de mí",
    ...
    "soñé con un lobo marino re lindo", 
     ...
     "", 
     "soñé q era el fin del mundo, había colectivos a los nuevos planetas", 
     "subía Néstor Kirchner y no tenía cargada la sube. nosotros le pagábamos el boleto",
     "ayer soñé que me sacaba un 2 (dos)",
     "soñé con La pérdida del reino de Bianco", 
     "sentía nostalgia de la época en que la leía",
  ...
  "soñé     ": [
     ...
     "soñé que un montón de zombies venían a mar del plata", 
     "soñé que construíamos una casa en el mar, abajo del agua", 
     "echaba raíces y teníamos que declararla en afip", 
  ...
  "soñé    ": [
     ...
     "soñé que el cielo estaba contaminado y había latas gigantes",
     "flotando tipo dibujo animado", 
     ...
     "soñé con el estado", 
     "era como una casa en la que me sentía bien", 
     "soñé que manejaba en una oscuridad absoluta", 
     "", 
     "soñé que compraba con €€€", 
     "soñé con san la muerte", 
     "soñé que salvaba a gente de un incendio y no me agradecían", 
     ...
     "me daba pena. estábamos en la residencia",
      "soñé toda la parte que me quedé dormida en la película de jodorowsky y ahora entiendo por qué jaime tiene las manos así", 
  ...
  "soñé   ":[
     ...
     "soñé que me lavaban la cabeza para lavarme las ideas y", 
     "después me quedaba ciega", 
  ...
  "soñé  ":[
     ...
     "soñé que alguien con mi mismo nombre se moría", 
     "por no poder cumplir un pacto con el diablo",
     "soñé con boy olmi",
     "soñé que alguien decía", 
     "'y si no somos inmortales porque no tomamos las decisiones correctas?'",
     "",
     "soñé que con @lumpenar comprábamos calabazas en Toledo", 
     "intentábamos cambiar las etiquetas del precio por otras más baratas",
     ...
     "soñé que hablaba con las pussy riot", 
     "soñé que una ráfaga de viento me partía el cuerpo en dos",
     ...
     "soñé que habían puesto transporte público en el mar", 
     "un tren que te llevaba de un lado a otro de la ciudad por el agua",
     "soñé que me encarcelaban por meter una moneda de otro país", 
     "en una máquina de gaseosas",
  ...
  "soñé ":[
     ...
     "y yo los encontraba en mi casa",
      "soñé que ponía unas fichas en el casino", 
     "salían unos pájaros que hacían una coreografía",
      ...
      "soñé que descubría que siempre que aparecía una perra en literatura era la misma perra", 
     "y decía 'guau, esta perra ya había aparecido en un cuento de Lugones y está acá, qué loco'",
      "soñé que tenía un motor en la mandíbula",
      "soñé con brea",
      "",
      "soñé que no me podían operar porque me olvidaba de hacer el ayuno", 
     "tenía que explicarle al médico y me decía 'ah un olvido freudiano'",
